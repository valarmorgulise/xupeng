#ifndef __PENG_HOOK_H__
#define __PENG_HOOK_H__
...
typedef ssize_t (*readv_fun)(int fd, const struct iovec *iov, size_t count);
extern readv_fun readv_f;

typedef ssize_t (*recv_fun)(int socketfd, void *buf, size_t len, int flags);
...
typedef int (*getsocket_fun)(int sockfd, int level, int optname, void *optval,
                             socklen_t *optlen);
extern getsocket_fun getsocket_f;

typedef int (*setsocket_fun)(int sockfd, int level, int optname,
                             const void *optval, socklen_t *optlen);
extern setsocket_fun setsocket_f;
